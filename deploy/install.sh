...
echo ""
read -rp "Enable auto-updates? [y/N] (default: N): " WT_CHOICE
...
echo ""
read -rp "Choose [1/2] (default: 1): " JWT_CHOICE
JWT_CHOICE="${JWT_CHOICE:-1}"

if [ "${JWT_CHOICE}" = "2" ]; then
  while true; do
    read -rsp "JWT secret (min 32 characters): " JWT_SECRET
    echo ""
...
# --- Domain name ---
echo ""
read -rp "Public domain name (e.g. https://analytics.yourcompany.com, or leave empty): " DOMAIN_NAME
